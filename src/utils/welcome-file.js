...
*** Click on the dash on the right to colapse a headline's children
** Notes don't have to be headlines
They can also be content
- Content text is grey
- Context text can not have children
* Want to make a list of tasks?
** TODO Mark a headline with TODO
Add some details about the task below in the content area
** DONE When your done you can mark the task done
** TODO [#A] Have alot of todo tasks? Give them a priority
